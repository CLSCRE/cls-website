...
def main():
    ...
    for _vslug, _vfile, _vpriority in _vertical_hubs:
        ...
        # Program mid-tier hubs (Phase A of the hub-and-spoke consolidation, see
        # docs/HUB_SPOKE_CONSOLIDATION_LOAN_SIZE_AFFORDABLE_HOUSING.md; generated by
        # scripts/generate_affordable_program_hubs.py). Glob-based so only real
        # generated mid-hubs get listed -- currently affordable-housing only.
        for _mh_path in sorted((WEBSITE_DIR / _vslug).glob("*/index.html")):
            sitemap_urls.append({
                "loc": f"{BASE_URL}/{_vslug}/{_mh_path.parent.name}/index.html",
                "lastmod": TODAY,
                "changefreq": "monthly",
                "priority": "0.85",
            })
