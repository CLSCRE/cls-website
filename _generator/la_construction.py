...
RAW_GUIDES = [
    {
        ...
        "sections": [
            ...
            {
                "heading": "Which Lenders Actually Show Up for ED1 Construction",
                "body": "The construction lender base for ED1 deals is narrower than for market-rate multifamily, and knowing which desks actually close these loans saves a sponsor months of dead-end conversations. CDFIs (community development financial institutions) and community or regional banks with a dedicated affordable-housing lending platform are the core of this market; they underwrite prevailing-wage construction budgets and LIHTC-paired capital stacks routinely and are comfortable with the specific documentation an ED1 deal produces, ministerial approval letters and plan-check correspondence rather than a discretionary entitlement record.\n\nWhat these lenders look for beyond the entitlement status itself is consistent: a general contractor with a real track record on prevailing-wage affordable projects specifically, since a GC that has only built market-rate work tends to underprice the labor and compliance cost, firm or near-firm LIHTC equity commitments rather than a projected allocation, and a sponsor with either direct affordable-housing delivery experience or a development partner who has it. A generalist construction lender unfamiliar with LIHTC timing and prevailing wage mechanics will often price the deal defensively or pass entirely, which is why matching an ED1 construction request to a lender that already knows this product move faster than shopping it broadly.",
            },
        ],
        "faqs": [
